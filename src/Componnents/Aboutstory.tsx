...
export default function Aboutstory(){
    return(
        ...
        transition={{duration: 2}}
         className='h-[85vh] shadow-lg  shadow-gray-400 w-[430px] bg-[#D83054] relative flex justify-start p-12 items-end'>
        ...
        initial={{y: 210 }}
        whileInView={{y: 0}}
        transition={{duration: 2}} className='h-full w-[40%] flex flex-col gap-3 '>
