...
function Hero() {
  return (
    <div className="md:h-screen  overflow-x-hidden h-[85vh] w-full bg-cover bg-center bg-no-repeat bg-[url(/images/herobg3.jpg)] flex lg:flex-row flex-col justify-center items-center">
        <motion.div
        initial={{x: 910 }}
        whileInView={{x: 0}}
