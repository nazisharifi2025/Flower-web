...
function Hero() {
  return (
    <div className="md:h-screen h-[85vh] w-full bg-cover bg-center bg-no-repeat bg-[url(/images/herobg3.jpg)] flex lg:flex-row flex-col justify-center items-center">
        <div className='lg:h-full h-[40%] flex justify-center items-center'>
            <img src="public/images/hero.webp" alt="" />
        </div>
        <div className=" lg:h-full h-[70vh] lg:w-1/2 md:w-[90%] w-full flex justify-center md:px-8 px-2 items-center">
