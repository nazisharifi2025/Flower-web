...
function ImgCard() {
  return (
    <div className='lg:h-[130vh] h-fit  lg:flex-row flex-col w-full flex lg:justify-end gap-12 lg:p-12 md:p-24 px-5 md:mb-0 mb-92 mt-12 '>
        <div className='md:h-[500px] md:w-[400px] h-[400px] w-[90%] border-8 shadow-xl shadow-gray-400 relative outline-4 border-white outline-white'>
        ...
        <div className='md:h-[400px] md:w-[600px] h-[300px] w-[90%] mx-auto border-8 relative shadow-xl shadow-gray-400 outline-4 lg:my-0 my-28 border-white outline-white'>
