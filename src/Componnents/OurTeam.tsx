...
function OurTeam() {
  ...
  return (
    <div className='w-full h-fit px-12 py-24 grid grid-cols-3 gap-24 items-center justify-center'>
        {Team.map((team,index)=>(
        <div key={index} className='h-[80vh] w-[420px] relative group'>
            ...
            <div className='h-[80vh] w-[420px] absolute top-0 right-0 transition-all duration-1000 ease-linear bg-black/40 opacity-0 group-hover:opacity-100 flex justify-center items-center space-x-4'>
