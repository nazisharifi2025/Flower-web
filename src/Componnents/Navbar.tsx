...
function Navbar() {
  ...
  return (
    <div className='w-full h-20 py-3 bg-pink-100 z-50 relative  md:px-12 px-3 lg:fixed flex justify-between items-center'>
        ...
        <ul className='text-black/70 lg:flex justify-center hidden font-medium items-center gap-10 text-lg'>
        ...
        {/* ul one  */}
         <ul className={`flex absolute w-full text-black/70 font-medium lg:hidden left-0 ${isOpin ?'top-0':'-top-[50vh]'} flex-col bg-pink-100 h-[50vh]  gap-1 text-lg`}>
